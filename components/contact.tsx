            ...
            >
                ...
                <div className="">
                    ...
                    <input
                        ...
                        {...register('name')}
                    />
                    {Boolean(errors.name.length) && <p className="text-red-500">Full Name {errors.message}</p>}
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        {...register('message')}
                    ></textarea>
                    {Boolean(errors.message.length) && <p className="text-red-500">Message {errors.message}</p>}
                </div>
                <div>
